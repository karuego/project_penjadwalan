...
def calculate_cost(schedule: List[JadwalItem]) -> int:
    """Menghitung biaya, kini dengan penalti untuk preferensi dan kelas online."""
    cost = 0
    PENALTI_BENTROK = 100
    PENALTI_DARING = 5
    PENALTI_PREFERENSI = 1 # Penalti kecil untuk pelanggaran preferensi
